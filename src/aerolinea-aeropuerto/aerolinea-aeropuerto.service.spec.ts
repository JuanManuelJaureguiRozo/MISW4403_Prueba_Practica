...
describe('AerolineaAeropuertoService', () => {
  ...
  it('addAeropuertoAerolinea should throw exception for an invalid aeropuerto', async () => {
    const newAerolinea: AerolineaEntity = await aerolineaRepository.save({
      nombre: faker.company.name(),
      descripcion: faker.lorem.sentence(),
      fecha_fundacion: faker.date.past(),
  ...
  it('deleteAeropuertoToAerolinea should throw an exception for an invalid aeropuerto', async () => {
  ...
  it('deleteAeropuertoToAerolinea should thrown an exception for a non asocciated aeropuerto', async () => {
    const newAeropuerto: AeropuertoEntity = await aeropuertoRepository.save({
      nombre: faker.company.name(),
      codigo: faker.string.alphanumeric(3),
      pais: faker.location.country(),
